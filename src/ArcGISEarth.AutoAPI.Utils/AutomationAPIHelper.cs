...
namespace ArcGISEarth.AutoAPI.Utils
{
    ...
    {
        public const string CameraControllerName = "camera";
        public const string FlightControllerName = "flight";
        public const string LayerControllerName = "layer";
        public const string LayersControllerName = "layers";
        public const string WorkspaceControllerName = "workspace";
        public const string SnapshotControllerName = "snapshot";
