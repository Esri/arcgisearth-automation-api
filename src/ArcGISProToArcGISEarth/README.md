...
### Build
Build and compile the add-in using source codes provided. Modify codes where necessary in your own program. If your ArcGIS Pro installation directory is not `C:\Program Files\ArcGIS\Pro`, you need to modify the value of `ProInstallDir` in the ArcGISProToArcGISEarth.csproj file to your custom installation directory.
